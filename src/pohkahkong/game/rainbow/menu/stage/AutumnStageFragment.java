 ...
 *
 */
public class AutumnStageFragment extends StageFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		rootView = (ViewGroup) inflater.inflate(R.layout.stage_autumn, container, false);						
		return rootView;
	}
	...
	public void onActivityCreated(Bundle savedInstanceState) {		
		...
		stageObjectsView.load(imageService.getAutumnObject());
	}	
}
